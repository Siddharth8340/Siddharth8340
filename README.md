...
* 📍 Chennai, India
* ☕ Learning Python Full Stack Development with Gen Ai
* ☁️ AWS Certified Cloud Practitioner
* 🤖 Oracle Cloud AI Foundations Certified
* 🌱 Currently improving Data Structures & Algorithms
* 💼 Seeking Full Stack Developer and Software Developer opportunities
...
## 📂 Projects
### 🚦 E-Challan for Traffic Violation System
A web-based application developed using PHP and MySQL to manage traffic violations digitally.
**Tech Stack:** HTML, CSS, PHP, MySQL
🔗 Repository:
https://github.com/Siddharth8340/E-challan-for-traffic-violation

### 🎙️ Audio Emotion Classification
Machine Learning project that classifies human emotions from speech audio using Python and Deep Learning.
